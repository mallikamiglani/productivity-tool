                ...
                <div className='flex min-h-full items-center justify-center p-4 text-center'>
                    ...
                    > 
                      ...
                      rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                        ...
                        <TaskTypeRadioGroup/>
                        {/* Insert image to todo */}
                        <div className='mt-2'>

                          <button className='w-full border border-gray-300 rounded-md outline-none p-5 focus-visible:ring-2 focus-visible: ring-stone-300 focus-visible:ring-offset-2'
                          onClick={() =>{
                        ...
                        <div className='mt-4'>
                          ...
                          className='inline-flex justify-center rounded-md border border-transparent
                           bg-blue-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-blue-50 
                           focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-300
                           focus-visible:ring-offset-2 disabled:bg-gray-100 disabled:text-gray-50 
